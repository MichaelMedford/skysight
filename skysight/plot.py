...
def three_exposures_plot(camera,
    ...
    *slewList* must contain at least three *dither.Slew* objects.
    ...
    cameraAOnly.plot(ax[1],
                     ...
                     xlim=xlim,
                     ylim=ylim)
    ax[1].set_title('1st Slew Only  '
                    '%.2f deg$^2$' % cameraAOnly.get_area(),
                    fontsize=10)
    ax[1].axis('off')
    ...
    cameraBOnly.plot(ax[2],
                     ...
                     xlim=xlim,
                     ylim=ylim)
    ax[2].set_title('2nd Slew Only  '
                    '%.2f deg$^2$' % cameraBOnly.get_area(),
                    fontsize=10)
    ax[2].axis('off')
    ...
    cameraCOnly.plot(ax[3],
                     ...
                     xlim=xlim,
                     ylim=ylim)
    ax[3].set_title('3rd Slew Only  '
                    '%.2f deg$^2$' % cameraCOnly.get_area(),
                    fontsize=10)
    ax[3].axis('off')
    ...
    cameraABOnly.plot(ax[4],
                      ...
                      xlim=xlim,
                      ylim=ylim)
    ax[4].set_title('1st/2nd Slews Only  '
                    '%.2f deg$^2$' % cameraABOnly.get_area(),
                    fontsize=10)
    ax[4].axis('off')
    ...
    cameraACOnly.plot(ax[5],
                      ...
                      xlim=xlim,
                      ylim=ylim)
    ax[5].set_title('1st/3rd Slews Only  '
                    '%.2f deg$^2$' % cameraACOnly.get_area(),
                    fontsize=10)
    ax[5].axis('off')
    ...
    cameraBCOnly.plot(ax[6],
                      ...
                      xlim=xlim,
                      ylim=ylim)
    ax[6].set_title('2nd/3rd Slews Only  '
                    '%.2f deg$^2$' % cameraBCOnly.get_area(),
                    fontsize=10)
    ax[6].axis('off')
    ...
    cameraABC.plot(ax[7],
                   ...
                   xlim=xlim,
                   ylim=ylim)
    ax[7].set_title('All Slews  '
                    '%.2f deg$^2$' % cameraABC.get_area(),
                    fontsize=10)
    ax[7].axis('off')
